...
Write-Log "Running comprehensive audit: 4-Backup-Audit" "INFO"
...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "4-Backup-Audit" -Format $OutputFormat
