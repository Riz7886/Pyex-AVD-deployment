...
$replacements = @(
    @{Find = 'PYEX-AVD-Deployment'; Replace = 'AVD-Deployment'},
    @{Find = 'PYEX-AVD'; Replace = 'AVD-Environment'},
    @{Find = 'Pyex-AVD-deployment'; Replace = 'AVD-Deployment'},
    @{Find = 'PYEX'; Replace = 'Company'},
    @{Find = 'Pyex'; Replace = 'Company'},
    @{Find = 'pyex'; Replace = 'company'}
)
...
- All scripts tested and working"
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "Repository: https://github.com/Riz7886/Pyex-AVD-deployment.git" -ForegroundColor Cyan
    } else {
        Write-Host ""
