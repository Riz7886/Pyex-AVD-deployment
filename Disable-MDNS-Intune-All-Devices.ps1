...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "Disable-MDNS-Intune-All-Devices" -Format $OutputFormat
