...
Write-Log "Running comprehensive audit: 5-Cost-Tagging-Audit" "INFO"
...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "5-Cost-Tagging-Audit" -Format $OutputFormat
