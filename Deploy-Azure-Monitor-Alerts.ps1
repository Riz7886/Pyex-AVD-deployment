...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "Deploy-Azure-Monitor-Alerts" -Format $OutputFormat
