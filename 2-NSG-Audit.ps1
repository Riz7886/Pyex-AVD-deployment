...
Write-Log "Running comprehensive audit: 2-NSG-Audit" "INFO"
...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "2-NSG-Audit" -Format $OutputFormat
