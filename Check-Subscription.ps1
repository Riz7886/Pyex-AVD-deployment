...
Write-Log "Starting Check-Subscription..."

$findings = @()

# Add specific logic for Check-Subscription
Write-Log "Collecting data for Subscription health check..."

# Placeholder - Add specific implementation
$findings += [PSCustomObject]@{
    ResourceName = "Sample"
    Status = "Active"
    Finding = "Subscription health check executed successfully"
...
$reportFiles = Export-ReportData -Data $findings -ReportName "Check-Subscription" -SubscriptionName $subscription.Name -Format $OutputFormat

Write-Host ""
Write-Host "Check-Subscription Complete" -ForegroundColor Green
