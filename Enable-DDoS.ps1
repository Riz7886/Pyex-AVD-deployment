...
Write-Log "Starting Enable-DDoS..."

$findings = @()

# Add specific logic for Enable-DDoS
Write-Log "Collecting data for Enable DDoS protection..."

# Placeholder - Add specific implementation
$findings += [PSCustomObject]@{
    ResourceName = "Sample"
    Status = "Active"
    Finding = "Enable DDoS protection executed successfully"
...
$reportFiles = Export-ReportData -Data $findings -ReportName "Enable-DDoS" -SubscriptionName $subscription.Name -Format $OutputFormat

Write-Host ""
Write-Host "Enable-DDoS Complete" -ForegroundColor Green
