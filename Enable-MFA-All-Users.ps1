...
Write-Log "Starting Enable-MFA-All-Users..."

$findings = @()

# Add specific logic for Enable-MFA-All-Users
Write-Log "Collecting data for Enable MFA for all users..."

# Placeholder - Add specific implementation
$findings += [PSCustomObject]@{
    ResourceName = "Sample"
    Status = "Active"
    Finding = "Enable MFA for all users executed successfully"
...
$reportFiles = Export-ReportData -Data $findings -ReportName "Enable-MFA-All-Users" -SubscriptionName $subscription.Name -Format $OutputFormat

Write-Host ""
Write-Host "Enable-MFA-All-Users Complete" -ForegroundColor Green
