...
Write-Log "Starting Idle-Resource-Report..."

$findings = @()

# Add specific logic for Idle-Resource-Report
Write-Log "Collecting data for Find idle and unused resources..."

# Placeholder - Add specific implementation
$findings += [PSCustomObject]@{
    ResourceName = "Sample"
    Status = "Active"
    Finding = "Find idle and unused resources executed successfully"
...
$reportFiles = Export-ReportData -Data $findings -ReportName "Idle-Resource-Report" -SubscriptionName $subscription.Name -Format $OutputFormat

Write-Host ""
Write-Host "Idle-Resource-Report Complete" -ForegroundColor Green
