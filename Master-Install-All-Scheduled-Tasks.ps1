...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "Master-Install-All-Scheduled-Tasks" -Format $OutputFormat
