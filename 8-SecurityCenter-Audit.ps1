...
Write-Log "Running comprehensive audit: 8-SecurityCenter-Audit" "INFO"
...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "8-SecurityCenter-Audit" -Format $OutputFormat
