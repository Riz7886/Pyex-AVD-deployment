...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "Migrate-DC-OnPrem-To-Azure" -Format $OutputFormat
