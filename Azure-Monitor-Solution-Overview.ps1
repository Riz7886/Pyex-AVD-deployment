...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "Azure-Monitor-Solution-Overview" -Format $OutputFormat
