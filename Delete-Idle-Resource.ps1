...
# Delete specific idle resources

$subscription = Connect-AzureWithSubscription

Write-Log "Starting Delete-Idle-Resource..."

$findings = @()

# Add specific logic for Delete-Idle-Resource
Write-Log "Collecting data for Delete specific idle resources..."

# Placeholder - Add specific implementation
$findings += [PSCustomObject]@{
    ResourceName = "Sample"
    Status = "Active"
    Finding = "Delete specific idle resources executed successfully"
...
$reportFiles = Export-ReportData -Data $findings -ReportName "Delete-Idle-Resource" -SubscriptionName $subscription.Name -Format $OutputFormat

Write-Host ""
Write-Host "Delete-Idle-Resource Complete" -ForegroundColor Green
