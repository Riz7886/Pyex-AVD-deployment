...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "Deploy-DataDog-Production" -Format $OutputFormat
