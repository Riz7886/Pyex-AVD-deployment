...
<#
Assign-DevOps-Role-SubProd-ASCII.ps1
Purpose:
...
Usage:
  .\Assign-DevOps-Role-SubProd-ASCII.ps1
  .\Assign-DevOps-Role-SubProd-ASCII.ps1 -RoleName Owner
  .\Assign-DevOps-Role-SubProd-ASCII.ps1 -WhatIf   # uses built-in WhatIf (no custom param)
#>
...
try {
  ...
  if ($WhatIfPreference) {
    Write-Warn "WHATIF run: No changes were made."
  } else {
