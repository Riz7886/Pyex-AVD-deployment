...
# Compare idle resources across timeframes

$subscription = Connect-AzureWithSubscription

Write-Log "Starting Azure-Idle-Compare-Report..."

$findings = @()

# Add specific logic for Azure-Idle-Compare-Report
Write-Log "Collecting data for Compare idle resources across timeframes..."

# Placeholder - Add specific implementation
$findings += [PSCustomObject]@{
    ResourceName = "Sample"
    Status = "Active"
    Finding = "Compare idle resources across timeframes executed successfully"
...
$reportFiles = Export-ReportData -Data $findings -ReportName "Azure-Idle-Compare-Report" -SubscriptionName $subscription.Name -Format $OutputFormat

Write-Host ""
Write-Host "Azure-Idle-Compare-Report Complete" -ForegroundColor Green
