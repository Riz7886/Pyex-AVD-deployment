...
Write-Log "Running comprehensive audit: 3-Encryption-Audit" "INFO"
...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "3-Encryption-Audit" -Format $OutputFormat
