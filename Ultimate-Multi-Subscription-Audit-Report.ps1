...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "Ultimate-Multi-Subscription-Audit-Report" -Format $OutputFormat
