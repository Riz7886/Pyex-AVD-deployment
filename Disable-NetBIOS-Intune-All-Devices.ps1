...
Export-ComprehensiveReport -Inventory $inventory -CostAnalysis $costAnalysis -DetailedFindings $findings -ReportName "Disable-NetBIOS-Intune-All-Devices" -Format $OutputFormat
